// Mirror of the on-chain enums in anchor_program/programs/vehicle_passport/src/state.rs
// Keep these two in sync — the SDK package will eventually generate them.
